# KRYPTO-VELAMEN -- Document Catalog
...
### Theory and Foundation (QUEER-prefixed)

| Filename | Type | Words | Key Concepts | Field |
|----------|------|------:|--------------|-------|
| QUEER-Qv33r-Project-Purpose.md | theory | 578 | Living cultural instrument, archival function, anti-futurism, media trajectory, public creation | Field I |
| QUEER-Queer-Aesthetic-of-Hiding.md | theory | 1,826 | Double-channel text, three author dials, six craft mechanisms, encoding schema, 25 recommended authors, four research clusters | Field I |
| QUEER-AI-prompts-for-QV33R.md | research | 3,742 | 25 world-research prompts, 9 consolidated prompts, QV33R World Research Operator meta-prompt template | All Fields |
| QUEER-QV33R-Research-Brief-Setup.md | research | 5,769 | Research brief for topics 1--5, timeline (17 entries), glossary (12 terms), case studies (4), claims ledger, ethical handling | All Fields |
| QUEER-Temporal-Work-and-Struggle.md | theory | 3,444 | Four-field model, conservation law, reference artist analyses (Whitman, Joyce, Tarkovsky, Kubrick, Tarantino) | All Fields |
...
| Filename | Type | Words | Key Topics |
|----------|------|------:|------------|
| ChatGPT-Project Threads Summary.md | thread_summary | 1,330 | All 7 projects in ETCETER4 creative universe |
| ChatGPT-QUEER Project Thread Summary.md | thread_summary | 846 | QUEER-specific threads, phases, themes, mediums |
| ChatGPT-GRINDER Project Threads Summary.md | thread_summary | 1,357 | GRINDER thread summary, same universe listing |

### Shared Source Material (ChatGPT Exports)

| Filename | Type | Words | Shared With | Notes |
|----------|------|------:|-------------|-------|
| ChatGPT-Demons in Paradise Lost.md | shared | 64,723 | CHTHON-ONEIROS | Largest doc -- extended Paradise Lost/demonology research |
| ChatGPT-Grinder Blair Witch Fear.md | shared | 392 | CHTHON-ONEIROS | Blair Witch fear-profile, found digital horror |
| ChatGPT-Grinder Project Public Creation.md | shared | 3,312 | CHTHON-ONEIROS | Digital-first screenplay format, Alien comparison |
| Temporal-Work-and-Struggle.md | shared | 3,444 | CHTHON-ONEIROS | Identical to QUEER-Temporal-Work-and-Struggle.md |

**Note on shared files:** 10 files total are shared with the companion project CHTHON-ONEIROS. Each repository maintains its own copy as self-contained source material -- no deduplication is imposed, because each project reads these documents through its own field lens. The complete list of shared files:

1. Temporal-Work-and-Struggle.md
2. QUEER-Temporal-Work-and-Struggle.md
3. ChatGPT-Demons in Paradise Lost.md
4. ChatGPT-Grinder Blair Witch Fear.md
5. ChatGPT-GRINDER Project Threads Summary.md
6. ChatGPT-Grinder Project Public Creation.md
7. ChatGPT-Monetization Strategy Priorities.md
8. ChatGPT-Release Strategy Enhancement.md
...
Walt Whitman, James Joyce, Andrei Tarkovsky, Stanley Kubrick, Quentin Tarantino
...
|--------------|---------------|
| Purpose | QUEER-Qv33r-Project-Purpose.md |
| Aesthetic | QUEER-Queer-Aesthetic-of-Hiding.md |
...
1. **Temporal-Work-and-Struggle.md** and **QUEER-Temporal-Work-and-Struggle.md** are byte-identical (22,929 bytes each). The unprefixed version is the original shared source document; the QUEER-prefixed version is the project-local copy.

2. **ChatGPT-QUEER Growth Strategy.md** and **ChatGPT-Queer Project Growth Strategy.md** are distinct documents despite similar names. The first (1,226 words) covers public creation strategy for both QUEER and GRINDER. The second (2,426 words) is a detailed three-phase growth plan specific to QUEER.
